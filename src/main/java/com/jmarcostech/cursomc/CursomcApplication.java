...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat4 = new Categoria(null,"Eletromesticos");
		Categoria cat5 = new Categoria(null,"Papelaria");
		Categoria cat6 = new Categoria(null,"Eletroeletronicos");
		Categoria cat7 = new Categoria(null,"Vestuario");
		Categoria cat8 = new Categoria(null,"Midias digitais");
		Categoria cat9 = new Categoria(null,"Periféricos");
